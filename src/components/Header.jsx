    ...
    <header className={`header ${isShow && 'header_show'}`}>
      ...
      <nav className={`header__nav ${isShow && 'header__nav_show'}`}>
        ...
        <button className="menu" onClick={handleShow}>
          <span className={`menu__line ${isShow && 'menu__line-1'}`}></span>
          <span className={`menu__line ${isShow && 'menu__line-2'}`}></span>
          <span className={`menu__line ${isShow && 'menu__line-3'}`}></span>
        </button>
        </>
            }
          />
